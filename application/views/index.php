    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="<?php echo base_url('assets/images/hero-bg.jpg');?>" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h1>
                    We are a creative person <br>
                    who like art design and <br>
                    influential brands, visual art <br>
                    and meaningfull art.
                </h1>

                <div class="home-content__buttons">
                    <a href="<?php echo base_url('index.php/Creart_profiles/signup');?>" class="smoothscroll btn btn--stroke">
                        Let's join us
                    </a>
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1 display-1--light">We Are CreArt</h1>
            </div>
        ...
        <div class="row about-desc" data-aos="fade-up">
            <div class="col-full">
                <p>
                CreArt adalah sebuah perusahaan startup di bidang teknologi portable gallery art. CreArt bukan hanya tentang gallery seni, akan tetapi tentang bagaimana seni itu dibuat, berada, dan memiliki makna yang mendalam tentangnya. CreArt memiliki tujuan sebagai perantara para creator seni untuk berkarya dan menjual hasil karyanya, memiliki gallery milik sendiri, dan karyanya dikenal masyarakat luas. 
                </p>
            </div>
        </div> <!-- end about-desc -->
    ...
    <section id='services' class="s-services">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-2">Kami memberikan fasilitas yang bisa kalian dapatkan di CreArt</h1>
            </div>
        </div> <!-- end section-header -->
        ...
        <div class="row services-list block-1-2 block-tab-full">
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>Karya seni yang dipublikasi oleh semua creator memiliki nilai legalitas dan hak cipta miliknya sendiri. Semua karya yang dipublikasi akan mendapatkan signature dan memiliki hak cipta miliknya. 
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>Karya seni yang dipublikasikan merupakan ilustrasi dari penjabaran karya seni yang memiliki beragam makna dan tidak hanya memiliki visual yang indah, tetapi memiliki makna yang mendalam.
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>Sistem marketing yang transparan, mudah dipahami, dan dengan fitur safety transaction sehingga sistem CreArt menjadi sangat mudah dipahami dan semua orang memiliki kesempatan untuk membuat karya.
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    <h3 class="h2">World Know</h3>
                    <p>Sistem ini dikenal oleh masyarakat dan dapat dikenal oleh masyarakat dunia tentang karya-karya gallery yang dibuatnya. Art Creator dapat membuat karya seninya dikenal oleh masyarakat luas.
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    <h3 class="h2">Solid Team and System</h3>
                    <p>CreArt memiliki sistem yang solid dan memiliki tim yang kompak dan kompeten. Sistem yang solid yang memberikan fasilitas kepada Art Creator untuk berkarya dan tim solid memberikan kemudahan akses dan safety transaction.
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    <h3 class="h2">Passion Development</h3>
                    <p>Sistem aplikasi yang selalu berkembang dengan sistem transaksi yang semakin aman dan dengan fitur-fitur yang lebih. Bisa membuat dan mengembangkan karya seni dan kreatifitas.
                    </p>
                </div>
            </div>
    ...
    <section id='works' class="s-works">
        ...
        <div class="intro-wrap">
            ...
            <div class="row section-header has-bottom-sep light-sep" data-aos="fade-up">
                <div class="col-full">
                    <h3 class="subhead">Best of Gallery Art</h3>
                    <h1 class="display-2 display-2--light">This is the best visual art with have deep meaning</h1>
                </div>
            </div> <!-- end section-header -->
                            ...
                            <div class="item-folio__thumb">
                                <a href="<?php echo base_url('assets/images/portfolio/gallery/g-shutterbug.jpg');?>" class="thumb-link" title="Shutterbug" data-size="1050x700">
                                    <img src="<?php echo base_url('assets/images/portfolio/lady-shutterbug.jpg');?>" 
                                         srcset="<?php echo base_url('assets/images/portfolio/lady-shutterbug.jpg 1x');?>, <?php echo base_url('assets/images/portfolio/lady-shutterbug@2x.jpg 2x');?>" alt="">
                                </a>
                            </div>
                            ...
                            <div class="item-folio__thumb">
                                <a href="<?php echo base_url('assets/images/portfolio/gallery/g-woodcraft.jpg');?>" class="thumb-link" title="Woodcraft" data-size="1050x700">
                                    <img src="<?php echo base_url('assets/images/portfolio/woodcraft.jpg');?>" 
                                         srcset="<?php echo base_url('assets/images/portfolio/woodcraft.jpg 1x');?>, <?php echo base_url('assets/simages/portfolio/woodcraft@2x.jpg 2x');?>" alt="">
                                </a>
                            </div>
                            ...
                            <div class="item-folio__thumb">
                                <a href="<?php echo base_url('assets/images/portfolio/gallery/g-palmeira.jpg');?>" class="thumb-link" title="Palmeira" data-size="1050x700">
                                    <img src="<?php echo base_url('assets/images/portfolio/palmeira.jpg');?>"
                                         srcset="<?php echo base_url('assets/images/portfolio/palmeira.jpg 1x');?>, <?php echo base_url('assets/images/portfolio/palmeira@2x.jpg 2x');?>" alt="">
                                </a>
                            </div>
